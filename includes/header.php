...
<head>
    ...
    <!-- para makita ang page title sa ibabaw -->
</head>
<body>
    <div class="container"> 
    <!-- it opens here and then it coles in the footer -->
    ...
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link" href="whiledowhileloop.php">Simple WhileDoWhile Loop</a></li>
